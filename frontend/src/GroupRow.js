    ...
    render() {
        return (
            <div style={{ width: '100%', height: '98px' }}>
                <div style={{ marginBottom: '1px', width: '100%', height: '96px', padding: '16px', cursor: 'pointer', backgroundColor: this.state.onHover ? 'rgba(0, 0, 0, 0.1)' : '#f2f2f2' }} onMouseOver={this.onHover} onMouseOut={this.onOut}>
